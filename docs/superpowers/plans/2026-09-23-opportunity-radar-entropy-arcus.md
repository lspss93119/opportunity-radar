...
- [ ] **Step 1: Add deterministic fixtures using the verified response shapes.**
...
- [ ] **Step 2: Write the failing Arcus parser/normalization tests.**
...
- [ ] **Step 3: Write the failing Entropy HIP-3 normalization test.**
...
- [ ] **Step 4: Add failing configuration and pipeline tests.**
...
- [ ] **Step 1: Implement the smallest parser dataclasses and parsers.**
...
- [ ] **Step 2: Implement concurrent per-market collection and normalized models.**
...
- [ ] **Step 3: Preserve fail-closed behavior and run the focused tests.**
...
- [ ] **Step 1: Add explicit fee validation without changing existing venue semantics.**
...
- [ ] **Step 2: Add conditional collectors.**
...
- [ ] **Step 3: Update the example configuration with only live-confirmed exact matches.**
...
- [ ] **Step 4: Run focused GREEN tests and the full non-live suite.**
...
- [ ] **Step 2: Run the live validations after unit tests pass.**
...
- [ ] **Step 3: Run available quality gates.**
...
- [ ] **Step 4: Self-review, commit logical changes, and leave the tree clean.**
